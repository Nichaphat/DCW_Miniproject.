...
let users = {
    users: [
        { id: 1, username: 'Nichapat', password: '$2b$10$0AsMSQaUB0AlLnKzgeUOfOE.hWUodtuR4NOU954XLVy2gy3lBWsdO', email: 'Nichapat@gmail.com', ischeck: 'No' },
        { id: 2, username: 'Aom', password: '$2b$10$1Bu4tImM/Ms9rtU.8/n/COWpzUAGFB6YlsO5xZqFih1JUxafyFFXa', email: 'ko@gmail.com', ischeck: 'No' },
    ]
}
...
let products = {
    products: [
        { id: 1, name: "Harry Potter", numberproduct: 1 }
    ]
}
